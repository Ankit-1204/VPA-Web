...
//             <Flex height="100vh">
//                 {/* Sidebar */}
//                 <Box width="20%" bg="gray.700" color="white" p={4}>
//                     <Box mb={4}>
...
const ProfileCircle = () => {
    ...
    return (
        <>
            <Avatar
                name={profile.name}
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.dreamstime.com%2Funknown-male-avatar-profile-image-businessman-vector-unknown-male-avatar-profile-image-businessman-vector-profile-image179373829&psig=AOvVaw3V8QB-dg1l1pzRyrxY9aSY&ust=1718129538039000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCKimqrnR0YYDFQAAAAAdAAAAABAE"// Placeholder image URL
                onClick={onOpen}
                cursor="pointer"
            />
            <Modal isOpen={isOpen} onClose={onClose}>
...
const Home = () => {
    ...
    const handleInputEvent = async () => {
        // Your existing input event handling logic
    };
        ...
        <ChakraProvider>
            <Flex height="100vh">
                ...
                <Box width="20%" bg="gray.700" color="white" p={4} display="flex" flexDirection="column">
                    <Box mb={4}>
                    <ProfileCircle />
                        <Text fontSize="lg" mb={2} mt={12}>Add Event</Text>
                        <Input
                            placeholder="Event Title"
                            value={newEventTitle}
                            onChange={(e) => setNewEventTitle(e.target.value)}
                    ...
                    {/* Add ProfileCircle component here */}
